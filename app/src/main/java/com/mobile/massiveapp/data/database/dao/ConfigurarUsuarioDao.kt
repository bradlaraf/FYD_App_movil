...
interface ConfigurarUsuarioDao:BaseDao<ConfigurarUsuariosEntity> {
    ...
    @Query("""
        SELECT 
            ...
            T0.DefaultAcctCodeEf,
            T0.DefaultAcctCodeTr,
            IFNULL((SELECT Z0.Code FROM Conductor Z0 WHERE Z0.Code = T0.DefaultConductor), '') AS DefaultConductor,
            T0.SuperUser,
            T0.AccLocked,
            T0.CanApprove,
            T0.CanCreate,
    ...
    @Query("""
        SELECT 
            ...
            IFNULL((SELECT Z0.Name FROM Conductor Z0 WHERE Z0.Code = T0.DefaultConductor), '') AS Conductor,
