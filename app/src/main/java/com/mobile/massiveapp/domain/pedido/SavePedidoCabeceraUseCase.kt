...
class SavePedidoCabeceraUseCase @Inject constructor(
    ...
    var mensaje = "Pedido enviado"
    var codigo = 0
    suspend operator fun invoke(pedidoCliente: ClientePedidos): DoError =
        try {
            ...
            val hashMapToSend = hashMapOf("ClientePedidos" to listOf(pedidoCliente as Any))
