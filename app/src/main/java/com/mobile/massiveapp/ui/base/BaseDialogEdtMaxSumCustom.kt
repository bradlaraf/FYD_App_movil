...
class BaseDialogEdtMaxSumCustom (
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.edtDialogValorInput.inputType = InputType.TYPE_CLASS_NUMBER or InputType.TYPE_NUMBER_FLAG_DECIMAL
        binding.edtDialogValorInput.setText(textEditable)
        binding.txvDialogWarning.isVisible = true


        binding.txvDialogWarning.text = "Cantidad máxima: $maxNumber"
        ...
        if(binding.edtDialogValorInput.text.toString().trim().isNotEmpty()){
            binding.edtDialogValorInput.addTextChangedListener { editable->
                ...
                if (editableSafe > maxNumber) {
                    binding.edtDialogValorInput.error = "$maxNumber como máximo"
                }
            }
        }
