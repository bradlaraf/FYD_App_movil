...
import com.mobile.massiveapp.databinding.FragmentManifiestoConSaldoBinding
...
@AndroidEntryPoint
class ManifiestoConSaldoFragment : Fragment() {
    private var _binding: FragmentManifiestoConSaldoBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentManifiestoConSaldoBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                manifiestoViewModel.dataGetManifiestosPendientes.collectLatest { lista ->
